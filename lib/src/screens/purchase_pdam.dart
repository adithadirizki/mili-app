...
class PurchasePDAMScreen extends StatefulWidget {
  ...
  const PurchasePDAMScreen(
      {Key? key, required this.vendor, this.destination, this.productCode})
      : super(key: key);

  @override
  _PurchasePDAMScreenState createState() => _PurchasePDAMScreenState();
}

class _PurchasePDAMScreenState extends State<PurchasePDAMScreen> {

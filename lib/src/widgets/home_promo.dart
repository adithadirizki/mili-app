...
class _HomePromoState extends State<HomePromo> {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(utc.toString());
    debugPrint(DateFormat('yyyy-MM-dd hh:mm:ss').format(utc.add(const Duration(hours: 7))).toString());
                ...
                children: activeBanner.bannerList.asMap().entries.map((e) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        color: currentIndex == e.key ? Colors.blue : Colors.blue.withOpacity(0.3)
                    ),
                  );
                }).toList(),
              ),
